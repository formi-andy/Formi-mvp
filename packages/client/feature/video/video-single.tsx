...
import { VideoActiveState, VideoQuality } from "@zoom/videosdk";
...
import { useParticipantsChange } from "./zoomHooks/useParticipantsChange";
      ...
      >
        ...
        {activeUser && (
          <Avatar
            ...
            volume={
              userVolumeList.find((u) => u.userId === activeUser.userId)?.volume
            }
