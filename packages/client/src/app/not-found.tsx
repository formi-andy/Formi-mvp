      ...
      <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
        <div>
          ...
          <div className="flex items-center mt-6 gap-x-3">
            <button
              className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto hover:bg-neutral-50"
              onClick={() => router.back()}
            >
              <svg
