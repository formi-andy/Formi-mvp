...
export default function SignupForm() {
  ...
  return (
    <form className="flex flex-col gap-y-4" onSubmit={(e) => register(e)}>
      ...
      <div>
        <button
          className="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
          type="submit"
        >
          Sign Up
        </button>
