...
const SiteDisclaimer = () => {
  return (
    <div className="flex flex-col gap-y-4 w-4/5 md:w-[600px] lg:w-[800px] rounded-lg p-8 bg-white border">
      ...
      <p className="text-lg font-bold">EXTERNAL LINKS DISCLAIMER</p>
      <p>
      ...
      <p className="text-lg font-bold">PROFESSIONAL DISCLAIMER</p>
      <p>
      ...
      <p>
        We do not provide any kind of medical/health advice. THE USE OR RELIANCE
        OF ANY INFORMATION CONTAINED ON THE SITE OR OUR MOBILE APPLICATION IS
